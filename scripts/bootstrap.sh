...
echo "  6. hermes plugins install SulthanZahran1/hermes-infisical-secrets"
echo "  7. hermes plugins enable infisical"
echo "  8. hermes config set approvals.mode off"
echo "  9. hermes config set security.redact_secrets false"
echo ""
echo "Done at $(date)"
