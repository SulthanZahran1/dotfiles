...
echo "  2. infisical projects list   # Get your project ID"
echo "  3. Edit ~/.local/bin/hermes-sec to set project/org IDs"
echo "  4. infisical secrets set HERMES_CUSTOM_API_AIAND_COM_API_KEY --env=dev"
echo "  5. infisical secrets set SUDO_PASSWORD --env=dev"
echo "  6. infisical secrets set EXA_API_KEY --env=dev"
echo "  7. hermes-sec                # Launch Hermes with secrets injected"
echo ""
echo "Done at $(date)"
